...
{  
  $cat=$row['cat_name'];
       $TABLE=$TABLE ."<div class='col-sm-6 col-md-4 col-lg-3 mb-3' data-aos='fade-up' data-aos-delay='100'>
            <a href='form.php?categories=$cat' class='h-100 feature-item'>
              <i style=' font-size: 50px ; padding-bottom:20px;'
   class=".$row["cat_img"]." ></i>
              <h2>".$row["cat_name"]."</h2>
              <span >".'<h2>'."".$row["cat_name_ar"]."".'</h2>'."</span> </a> </div>";
}
   // $TABLE=$TABLE."  </a> </div>";
